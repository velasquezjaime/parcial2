                ...
                if ($h1 == 1) {
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3">
                        <div class="card" style="width: 18rem; border-radius: 5px; background: radial-gradient(#1fe4f5, #3fbafe); margin-top:15px; border-width:3px; box-shadow: 0px 6px 10px rgba(0, 0, 0, 0.4);">
                            <img src="assets/img/<?php echo $resultado["id"] ?>.png" class="card-img-top" alt="...">
                            <div class="card-body">
                                <h3 style="text-align:center"><strong><?php echo $resultado["producto"] ?></strong></h3>
                                <p class="card-text" style="text-align:center; font-size: 17px"><?php echo $resultado["descripcion"] ?>.</p>
                                <h3 style="text-align:center"><?php echo $resultado["costo"] ?>$</h3>
                                <p style="text-align:center"><h7>ITBMS: <?php echo $resultado["precioventa"] ?> $</h7></p>
                                <hr>
                                <p style="text-align:center">Cantidad disponible: <strong> <?php echo $resultado["cantidad"] ?> unidades </strong></p>
                            </div>
                        </div>
                    </div>
